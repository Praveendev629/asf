  ...
  return (
    <header className="sticky top-0 z-40 bg-white border-b border-gray-100">
      <div className="max-w-6xl mx-auto flex items-center gap-3 px-4 py-3">
        ...
        {/* Menu */}
        <button onClick={() => setShowMenu(!showMenu)} className="p-2 rounded-xl bg-gray-100 relative">
              ...
              <>
                <div className="flex items-center gap-3 pb-3 border-b border-gray-100">
                  {profile?.photoURL ? (
                    ...
                    <div className="w-10 h-10 rounded-full bg-emerald-100 flex items-center justify-center"><User size={20} className="text-emerald-600" /></div>
                  )}
                  <div>
