    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-700 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-3xl font-semibold text-white">Delivery Partner</h1>
          <p className="text-white/60 mt-2">Create your delivery partner account</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="bg-white rounded-2xl p-8 shadow-xl space-y-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-gray-900 text-white font-semibold py-3 rounded-xl hover:bg-gray-800 transition disabled:opacity-50"
          >
          ...
          <p className="text-center text-sm text-gray-500">
            Already registered?{" "}
            <Link href="/delivery/login" className="text-gray-900 font-medium hover:underline">
              Sign in
            </Link>
          </p>
        </form>
